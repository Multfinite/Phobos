...
enum struct ExtensionIdentifier : DWORD
{
	...
	, TemporalClass = 0xFFFFFF42
	, TerrainClass = 0xFFFFFF43
	, TriggerClass = 0xFFFFFF46
	, UnitClass = 0xFFFFFF47
	, UnitTypeClass = 0xFFFFFF48
	, VeinholeMonsterClass = 0xFFFFFF49
	, WaveClass = 0xFFFFFF50
	, WaypointTypeClass = 0xFFFFFF51
...
public: \
	...
	\
	constexpr extension_type** ptr() noexcept { return reinterpret_cast<extension_type**>((reinterpret_cast<std::byte*>(this)) + extension_type::Offset); } \
	constexpr extension_type& extension() noexcept { return **ptr(); } \
	constexpr operator extension_type& () noexcept { return extension(); } \
	constexpr operator extension_type* () noexcept { return &extension(); } \
private: \
